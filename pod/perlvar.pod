...
Current state of the interpreter.  Undefined if parsing is active
(may happen in $SIG{__DIE__} and $SIG{__WARN__} handlers).  True if
inside an eval, othewise false.
